...
export default function ProfilePage() {
  ...
  return (
    <Box display="flex" justifyContent="center" w="full" minH="85vh">
      <Box w="full" maxW="600px" px={4}>
        ...
        <VStack gap={6} align="stretch">
          ...
          <Box>
            ...
            />
            {error.phone && <Text fontSize="sm" color="red.500" textAlign="center">{error.phone}</Text>}
          </Box>
