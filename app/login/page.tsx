      ...
      <Container maxW="md">
        ...
        <VStack gap={4}>
          ...
          <Flex align="center" w="full">
            {" "}
            {/* VStack이 세로형 책꽃이였다면, Flex는 가로 방향으로 정렬하는 책꽃이, 세로는 중앙에 배치*/}
            <Box flex="1" h="1px" bg="rgba(0, 0, 0, 0.4)" />{" "}
            {/* flex="1"을 해주면 남는 공간을 모두 차지한다는 뜻 */}
            <Text px={4} fontSize="12px" color="rgba(0, 0, 0, 0.4)">
              {" "}
              {/* px={4} => px="16px"과 같은 뜻, x축 좌우 여백을 16px만큼 줌.*/}
              또는
            </Text>
            <Box flex="1" h="1px" bg="rgba(0, 0, 0, 0.4)" />
          </Flex>
