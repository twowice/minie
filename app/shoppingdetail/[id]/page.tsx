...
export default function ShoppingDetail() {
   ...
   const createCartItem = () => {
      ...
      const cleanDiscount = safeNumber(product.discount_amount ?? product.is_discounted);
   ...
   // 답변 팝업 핸들러
   const handleOpenReply = (e: React.MouseEvent<HTMLButtonElement>, item: QnaItem) => {
      e.stopPropagation();
      setSelectedQna(item);
            ...
            <Flex gap={'40px'} paddingBottom={'40px'} borderBottom={'1px solid rgba(204,204,204,0.8)'}>
               ...
               <Flex direction={'column'} gap={'16px'} flex={1}>
                  ...
                  <HStack gap={'20px'} w={'100%'}>
                     ...
                     <Button bgColor={'#FA6D6D'} color={'white'} flex={1} onClick={handleBuyClick}>
                        바로 구매
                     </Button>
                  </HStack>
               </Flex>
         ...
         >
            ...
            <Tabs.Content value="QnA">
               <Box mb={'32px'}>
                  ...
                  {qnaList.length === 0 ? (
                     <Box p={'40px 0'} textAlign={'center'} color={'gray.500'} borderBottom={'1px solid #cccccc'}>
               ...
               <Dialog.Root placement={'center'} open={replyOpen} onOpenChange={isOpen => !isOpen && onReplyClose()}>
                  <Dialog.Backdrop />
                  <Dialog.Positioner>
                     <Dialog.Content bg={'white'} color={'black'} w={'400px'}>
                        <Dialog.Header
