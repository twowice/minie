...
export default function LikedItem({
   ...
   return (
      ...
      >
         ...
         <Flex flex={1} flexDirection={'column'} justifyContent={'space-between'} minH={'130px'}>
            ...
            {cartHas && (
               <Box display={'flex'} justifyContent={'flex-end'} fontSize={'12px'} fontWeight={'medium'}>
                  장바구니에 담긴 상품
               </Box>
            )}
            {item.isDiscounted && (
            ...
            <Box>
               <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                  <IconButton
                     ...
                     bgColor={'transparent'}
                  >
                     <HeartFilledIcon filledColor={'#FA6D6D'} strokeColor={'#FA6D6D'} />
                  </IconButton>
