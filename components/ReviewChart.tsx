...
export default function ReviewChart({
  ...
  return (
    <Container maxW={"7xl"} px={{ base: 4, sm: 6, lg: 8 }}>
      <Box py="24px">
        <Flex justifyContent="space-between" w="100%" borderBottom="1px solid #D8D8D8" alignItems="center">
          {/* 헤더 */}
          <Text fontSize="24px" mb={1} color="black" fontWeight="regular">
            상품 리뷰
          </Text>
          <Text fontSize="16px" color="black" pb="0px">
            <Text as="span" fontSize="16px" fontWeight="bold" color="black">
            ...
            <Dialog.Root key={review.id}>
              <Flex key={review.id} borderBottom="1px solid #E3E3E3" p="16px" gap="30px" borderRadius="5px">
                ...
                <VStack align="stretch" flex="1">
                  ...
                  <Text fontSize="12px" color="#A8A8A8" textAlign="left">
