                ...
                <Dialog.Positioner>
                    ...
                    >
                        ...
                        <Dialog.Footer p="0" paddingTop="10px">
                            <Flex w="100%" gap="8px">
                                <Button flex="1" bg="#FFFFFF" border="1px solid #cececeff" borderRadius="4px" fontSize="16px" color="#000000" _hover={{ bg: "#f5f5f5", borderColor: "#bfbfbf" }}>삭제</Button>
                                <Button flex="1" bg="#FA6D6D" borderRadius="4px" fontSize="16px" color="#FFFFFF" _hover={{ bg: "#ff8e8eff" }} onClick={handleSave} >저장</Button>
                            </Flex>
                        </Dialog.Footer>
                        <Dialog.CloseTrigger asChild>
                            <CloseButton size="sm" mt="10px" color="black" _hover={{ bg: "#f9f9f9" }} />
                        </Dialog.CloseTrigger>
                    </Dialog.Content>
                </Dialog.Positioner>
            </Portal>
