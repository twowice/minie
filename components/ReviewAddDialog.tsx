...
export default function reviewDialogDialog({ id, content, reviewImage, productName, productImage, reviewrating, userId, loginUserId, productId, onUpdate, onSuccess, onFail, onDelSuccess, onDelFail }: reviewAddDialogProps) {
    /* 별점 & 설명 & 리뷰사진 & 닫기 */
